...
hn::Vec<hn::ScalableTag<uint16_t>> WidenMulAccTo16Wmacclib(
    ...
    return hn::WidenMulAccumulate(d16, a, b_masked, sum0, sum1);
}

hn::Vec<hn::ScalableTag<uint32_t>> WidenMulAccTo32Wmacclib (
    ...
    return hn::WidenMulAccumulate(d32, a, b_masked, sum0, sum1);
}
    
size_t varint_decode_hwy_portable_wmacclib(const uint8_t* HWY_RESTRICT input, size_t length, uint32_t* HWY_RESTRICT output) {
    ...
    while (length >= N8) {
        ...
        if (num_varints == N8) {
            ...
            V16 result12_16_lo = WidenMulAccTo16Wmacclib(
                    b2, 
                    hn::Set(d8, 128), 
                    b1_16_lo, 
                    b1_16_up, 
            ...
            if (count3 == 0) {
                ...
                V16 result34_16_lo = WidenMulAccTo16Wmacclib(
                        b4, 
                        hn::Set(d8, 128), 
                        b3_16_lo, 
                        b3_16_up,
                ...
                V32 result1234_32_lolo = WidenMulAccTo32Wmacclib(
                        result34_16_lo,
                        hn::Set(d16, 16384),
                        result12_32_lolo,
                        result12_32_loup,
                ...
                V32 result1234_32_uplo = WidenMulAccTo32Wmacclib(
                        result34_16_up,
                        hn::Set(d16, 16384),
                        result12_32_uplo,
                        result12_32_upup,
                ...
                if (count5 > 0) {
                    ...
                    // WidenMulAccTo32Wmacclib can not be used because 2<<28 > uint16_max
...
extern "C" {
    size_t call_varint_decode_hwy_portable_wmacclib(const uint8_t* HWY_RESTRICT input, size_t length, uint32_t* HWY_RESTRICT output) {
        return HWY_STATIC_DISPATCH(varint_decode_hwy_portable_wmacclib)(input, length, output);
    }
}
