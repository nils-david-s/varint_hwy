...
int main(void) {
    ...
    success &= test_decoder(encoded_data, encoded_length, original_data, N, "Riscv highway", call_varint_decode_hwy_riscv);
    success &= test_decoder(encoded_data, encoded_length, original_data, N, "Riscv highway wamcclib", call_varint_decode_hwy_riscv_wmacclib);
    success &= test_decoder(encoded_data, encoded_length, original_data, N, "Riscv highway nomask", call_varint_decode_hwy_riscv_nomask);
    success &= test_decoder(encoded_data, encoded_length, original_data, N, "Riscv highway mul add", call_varint_decode_hwy_riscv_mul_add);
